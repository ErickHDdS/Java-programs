...
public class JanelaPrincipal extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
		...
		if (((JButton)e.getSource()).getText().equals(" Consultar ")) 
                {
			Contato c = agenda.pesquisar(nome.getText(), telefone.getText());
                        if(c.getNome() == null)
                        {
                            JOptionPane.showMessageDialog(this, "Contato não encontrado", "FALHA", JOptionPane.ERROR_MESSAGE);
                        }
                        else
                        {
		...
		if (((JButton)e.getSource()).getText().equals(" Gravar ")) 
                {
			agenda.gravar();
                        JOptionPane.showMessageDialog(this, "Contato salvo na agenda!", "Salvamento Automático", JOptionPane.INFORMATION_MESSAGE);
		}
	}
}
