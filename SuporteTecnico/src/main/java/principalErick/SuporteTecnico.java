...
public class SuporteTecnico {
    ...
    public String procurandoSolucao(HashSet<String> palavraChave)
    {
        String resposta = null;
        Iterator<String> itPalavraChave = palavraChave.iterator();
        while(itPalavraChave.hasNext())
        {
            String palavraChave_aux = itPalavraChave.next();
            if(this.bancoSolucoes.containsKey(palavraChave_aux))
            {
                return this.bancoSolucoes.get(palavraChave_aux).intern();
            }
        }
        return resposta;
    }
    
    public String procurarAleatoria()
    {
        Random gerador = new Random();
        int number = gerador.nextInt(9);
        Iterator<String> it = this.respostaPadrao.iterator();
        String aux = null;
